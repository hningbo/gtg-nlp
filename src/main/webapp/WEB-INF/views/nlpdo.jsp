                            ...
                            <div class="panel-body">
                                <form action="nlp.do" name="nlpform" method="POST" >
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="content" class="form-control" rows="8" placeholder="输入您要分析的文段">
                                    </div>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <c:forEach items="${claims}" var="c">
                                                    <tr>
                                                        <td>
                                                            <input type="text" name="" id="input" class="form-control" value="${c.subject}">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="" id="input" class="form-control" value="${c.predicate}">
                                                        </td>
                                                        <td>
                                                            <input type="text" name="" id="input" class="form-control" value="${c.object}">
                                                        </td>
                                                    </tr>
                                                </c:forEach>
                                            </tbody>
